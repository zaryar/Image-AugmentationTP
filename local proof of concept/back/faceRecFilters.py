...
harcascade = ("local proof of concept/back/faceRec_files/haarcascade_frontalface_default.xml")
detector = cv.CascadeClassifier(harcascade)
LBFmodel = ("local proof of concept/back/faceRec_files/lbfmodel.yaml")
